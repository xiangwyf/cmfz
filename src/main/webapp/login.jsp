	...
	<script type="text/javascript">
        ...
        $(function(){
            ...
            $("#captchaImage").click(function(){//点击更换验证码
                $("#captchaImage").prop("src","${pageContext.request.contextPath}/code/changeCode?date="+new Date());
            });
					  ...
					  <tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/code/changeCode" title="点击更换验证码"/>
							</td>
						</tr>					
					<tr>
						<td>
